...
Shader "Hidden/Clouds"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Scenes/Cloud/Scripts/Version2/Shaders/CloudDebug.cginc"
            ...
            // Debug settings:
            // 0 = off; 1 = shape tex; 2 = detail tex; 3 = weathermap
            int debugViewMode;
            int debugGreyscale;
            ...
            float sampleDensity(float3 rayPos) {
                ...
                const float containerEdgeFadeDst = 500;
                const float edgeFadeFactor = 0.01;
                ...
                float edgeDst = min(dstFromEdgeZ, dstFromEdgeX);
                float edgeWeight = 1.00;

                edgeWeight = exp((clamp(edgeDst, 0.00, containerEdgeFadeDst) / containerEdgeFadeDst - 1) * edgeFadeFactor);
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                while (dstTravelled < dstLimit) {
                    ...
                    if (density > 0) {
                        ...
                        lightEnergy += density * stepSize * transmittance * lightmarch(rayPos) * phaseVal;
