...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    public static class PBRLitGUI
    {
        ...
        public static class Styles
        {
            ...
            /// <summary>
            /// The text and tooltip for the SSSS map GUI.
            /// </summary>
        ...
        public static void Inputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            //SSS 
            DoSSSArea(properties, materialEditor, material);
        }
        static void DrawFloatToggleProperty(GUIContent styles, MaterialProperty prop, int indentLevel = 0, bool isDisabled = false)
        {
            if (prop == null)
                return;
        ...
        public static void DoSSSArea(LitProperties properties,MaterialEditor materialEditor,Material material)
        {
            if (properties.SSSMap==null)
            {
                return;
            }
            else
